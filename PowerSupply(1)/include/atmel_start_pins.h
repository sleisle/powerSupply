 ...
 */
static inline void VIn_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(4, pull_mode);
}

/**
 * \brief Set VIn data direction
 *
 ...
 *                      (low power state)
 */
static inline void VIn_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(4, dir);
}

/**
 * \brief Set VIn input/sense configuration
 *
 * Enable/disable VIn digital input buffer and pin change interrupt,
 ...
 */
static inline void VIn_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(4, isc);
}

/**
 * \brief Set VIn inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on VIn is inverted
 *                     false = I/O on VIn is not inverted
 */
static inline void VIn_set_inverted(const bool inverted)
{
 ...
 */
static inline void VIn_set_level(const bool level)
{
	PORTA_set_pin_level(4, level);
}

/**
 * \brief Toggle output level on VIn
 *
 * Toggle the pin level
 */
static inline void VIn_toggle_level()
{
	PORTA_toggle_pin_level(4);
}

/**
 * \brief Get level on VIn
 *
 * Reads the level on a pin
 */
static inline bool VIn_get_level()
{
